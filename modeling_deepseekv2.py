...
class FlashDeepseekV2Model(torch.nn.Module):
    def __init__(self, config, weights, llm_config=None, init_expert_table=None, mix_shared_routing=False):
        super().__init__()
