...
class EplbRebalanceLoader:
    ...
    def __init__(self, flash_causal_model, rank_id, model_name_or_path="", enable_eplb_multi_process=False):
        ...
        if self.enable_eplb_multi_process:
            self.eplb_loader_process = EplbLoaderProcess(flash_causal_model.weights, rank_id)
